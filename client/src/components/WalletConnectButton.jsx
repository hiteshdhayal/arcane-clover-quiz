      ...
      <style>
        {`
          .wallet-button-container .wallet-adapter-button {
            background: linear-gradient(135deg, rgba(61, 61, 61, 0.95), rgba(30, 30, 30, 0.95)) !important;
          ...
          .wallet-button-container .wallet-adapter-button:hover {
            ...
            background: linear-gradient(135deg, rgba(80, 80, 80, 0.95), rgba(50, 50, 50, 0.95)) !important;
          }
